...
class ptycho:
      ...
      def __init__(self, dp, dk, initialProbe, ppX, ppY):
          ...
          self.paraDict['plot_recon'] = False
          
          #mixed-states
          self.paraDict['N_probe'] = 1
          self.paraDict['N_object'] = 1          
          self.paraDict['Niter_update_states'] = 1000 #Since which iteration to do mixed-state update
          self.paraDict['Niter_update_position'] = 1000 # start position refinement
